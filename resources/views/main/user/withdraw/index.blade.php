    ...
    <div class="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
        <div class="container-fluid px-0">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="h2 mb-0 lh-sm">Withdraw</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-6">
                        <div class="card mb-4 rounded-12 shadow border border-gray-50">
                            <div class="card-body p-3 p-xl-3 p-xxl-4">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <span class="small text-gray-600 d-block mb-1">Withdraw Requested</span>
                        ...
                        <form action="{{ url('process-withdraw') }}" class="ajax-form-success px-3" data-success="{{url('withdraw')}}" method="POST" files="true" enctype="multipart/form-data">
                            ...
                            <div class="mb-2 mb-md-3 mb-xl-4 pb-3">
                                <ul class="nav nav-tabs nav-tabs-md nav-tabs-line position-relative zIndex-0" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-bank-tab" onclick="set_payment_method(2)" data-bs-toggle="pill" data-bs-target="#pills-bank" type="button" role="tab" aria-controls="pills-bank" aria-selected="false">Bank Transfer</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-coin-tab" onclick="set_payment_method(3)" data-bs-toggle="pill" data-bs-target="#pills-coin" type="button" role="tab" aria-controls="pills-coin" aria-selected="false">Crypto</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="card-body px-0 p-md-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 pb-3 mb-md-4">
                                                    ...
                                                    @if($banks->count() == 0)
                                                    <label class="form-label form-label-lg"><small>No bank accounts available. <a class='text-info' href="{{url('bank-account/create')}}">Add New</a></small></label>
                                                    @endif
                                                </div>

                                                <div class="col-md-6 pb-3 mb-md-4">
                                                    <label class="form-label form-label-lg">Withdraw Amount <i class="text-danger">*</i></label>
                                                    <input class="form-control form-control-xl" name="withdraw_amount_bank" placeholder="Enter Withdraw Amount" type="text">
                                                </div>
                                        ...
                                        <div class="card-body px-0 p-md-4">
                                            ...
                                            <div class="row form-group mb-3 mt-3">
                                                ...
                                                <div class="col-md-6 pb-3 mb-md-4">
                                                    ...
                                                    @if($cryptos->count() == 0)
                                                    <label class="form-label form-label-lg"><small>No crypto wallets available. <a class='text-info' href="{{url('crypto-wallet/create')}}">Add New</a></small></label>
                                                    @endif
                                                </div>

                                                <div class="col-md-6 pb-3 mb-md-4">
                                                    <label class="form-label form-label-lg">Withdraw Amount <i class="text-danger">*</i></label>
                                                    <input class="form-control form-control-xl" name="withdraw_amount_crypto" placeholder="Enter Withdraw Amount" type="text">
                                                </div>
