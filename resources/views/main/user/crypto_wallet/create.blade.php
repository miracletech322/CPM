...
<div class="row mt-5">
    <div class="col-md-12 mb-2">
        <div class="d-flex">
            ...
            <h2 class="small-title me-2"><a href="{{url('crypto-wallet')}}">{{$title_singular}}</a></h2>
            <div class="dropdown-as-select me-3 small-title">
                <i class="pe-0 pt-0 align-top lh-1 dropdown-toggle" href="#" aria-expanded="false">
                    <span class="small-title"></span>
                </i>
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <form action="{{ url('crypto-wallet') }}" class="ajax-form-success" data-success="{{url('crypto-wallet')}}" method="POST" files="true" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
