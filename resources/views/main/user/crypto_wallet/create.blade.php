        ...
        <div class="container-fluid px-0">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h1 class="h2 mb-0 lh-sm">{{__("Create")}} {{$title_singular}}</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xxl-12 mb-4">
                ...
                <div class="card rounded-12 shadow-dark-80 border border-gray-50 mb-3 mb-xl-5">
                    <div class="d-flex align-items-center px-3 px-md-4 py-3 border-bottom border-gray-200">
                        <h5 class="card-header-title my-2 ps-md-3 font-weight-semibold">{{__("Create")}} {{$title_singular}}</h5>
                    </div>
                    <div class="card-body px-0 p-md-4">
                        <div class="bd-example">
                            <form action="{{ url('crypto-wallet') }}" class="ajax-form-success px-3" data-success="{{url('crypto-wallet')}}" method="POST" files="true" enctype="multipart/form-data">
                                @csrf()
