...
<div class="container">
    <div class="page-title-container">
        <div class="row">
            <div class="col-12 col-md-7">
                ...
                <h1 class="mb-0 pb-0 display-4" id="title">Welcome, {{Auth::user()->first_name}}! 
                {{-- Template: "https://acorn-html-classic-dashboard.coloredstrategies.com/"> --}}
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="text-primary cta-4">{{$total_users}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">ADMINS</div>
                                <div class="text-primary cta-4">{{$total_admins}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">DEPOSIT REQUESTS</div>
                                <div class="text-primary cta-4">{{$total_deposit_requests}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">WITHDRAW REQUESTS</div>
                                <div class="text-primary cta-4">{{$total_withdraw_requests}}</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex">
                <h2 class="small-title">Current Prices</h2>
            </div>
            <div class="mb-5">
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                    <i data-acorn-icon="bitcoin" class="text-primary"></i>
                                </div>
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">BTC (SHA-256)</div>
                                <div class="text-primary cta-4">$ {{to_cash_format($pageData["sha_256"]->price)}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">ETH (Ethash)</div>
                                <div class="text-primary cta-4">$ {{to_cash_format($pageData["ethash"]->price)}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">ZEC (Equihash)</div>
                                <div class="text-primary cta-4">$ {{to_cash_format($pageData["equihash"]->price)}}</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="scroll-by-count" data-count="4">
                        ...
                        <div class="row g-0 sh-14 sh-md-10">
                            <div class="col-auto">
                                <a href="Products.Detail.html">
                                    <img src="{{asset('backend')}}/img/product/small/product-3.webp" alt="alternate text" class="card-img card-img-horizontal sw-11">
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-14 sh-md-10">
                            <div class="col-auto">
                                <a href="Products.Detail.html">
                                    <img src="{{asset('backend')}}/img/product/small/product-2.webp" alt="alternate text" class="card-img card-img-horizontal sw-11">
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-14 sh-md-10">
                            <div class="col-auto">
                                <a href="Products.Detail.html">
                                    <img src="{{asset('backend')}}/img/product/small/product-7.webp" alt="alternate text" class="card-img card-img-horizontal sw-11">
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-14 sh-md-10">
                            <div class="col-auto">
                                <a href="Products.Detail.html">
                                    <img src="{{asset('backend')}}/img/product/small/product-6.webp" alt="alternate text" class="card-img card-img-horizontal sw-11">
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-14 sh-md-10">
                            <div class="col-auto">
                                <a href="Products.Detail.html">
                                    <img src="{{asset('backend')}}/img/product/small/product-8.webp" alt="alternate text" class="card-img card-img-horizontal sw-11">
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card-body mb-n2 scroll-out h-100">
                            <div class="scroll h-100">
                                <div class="row g-0 sh-10 mb-3">
                                    <div class="col-auto">
                                        <a href="Products.Detail.html">
                                            <img src="{{asset('backend')}}/img/product/small/product-2.webp" class="card-img rounded-md h-100 sw-8" alt="thumb">
                                        </a>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row g-0 sh-10 mb-3">
                                    <div class="col-auto">
                                        <a href="Products.Detail.html">
                                            <img src="{{asset('backend')}}/img/product/small/product-3.webp" class="card-img rounded-md h-100 sw-8" alt="thumb">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <div class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                                ...
                                <div class="row g-0 sh-10 mb-3">
                                    <div class="col-auto">
                                        <a href="Products.Detail.html">
                                            <img src="{{asset('backend')}}/img/product/small/product-1.webp" class="card-img rounded-md h-100 sw-8" alt="thumb">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <div class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                                ...
                                <div class="row g-0 sh-10">
                                    <div class="col-auto">
                                        <a href="Products.Detail.html">
                                            <img src="{{asset('backend')}}/img/product/small/product-10.webp" class="card-img rounded-md h-100 sw-8" alt="thumb">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <div class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
